...
""
function solve_sots_iv_acdc_deneme2(data::Dict, model_constructor, optimizer; deg::Int=1, p_size=0, solution_processors=[sol_data_model!], kwargs...)
    ...
    result = _PM.solve_model(data, model_constructor, optimizer, build_sots_iv_acdc_deneme2; multinetwork=true, ref_extensions = [_PMACDC.add_ref_dcgrid!, _SPM.add_ref_RES!], solution_processors=solution_processors, kwargs...)
...
""
function build_sots_iv_acdc_deneme2(pm::AbstractPowerModel)
